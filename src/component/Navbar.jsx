      ...
      <nav className="bg-black">
        ...
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t border-gray-200">
            <a href="#map" className="block px-3 py-2 text-gray-900 hover:bg-gray-100 rounded-md">
              Map
            </a>
            <a href="#statistics" className="block px-3 py-2 text-gray-900 hover:bg-gray-100 rounded-md">
              Statistics
            </a>
